...
from src.training.trainer import SubgraphTrainer, GraphTrainer, GATTrainer
...
def main():
    ...
    ################################Baseline GAT################################
    macro_arch_trainer = GATTrainer(
        model_args={
            'in_channels': args.GAT_baseline_in_channels,
            'hidden_channels': args.GAT_baseline_hidden_channels,
            'num_layers': args.GAT_baseline_num_layers,
            'num_regs': args.GAT_baseline_num_regs,
            'num_classes': args.GAT_baseline_num_classes,
        },
    ...
    #     model_args={
    #         'in_channels': args.GCN_baseline_in_channels,
    #         'hidden_channels': args.GCN_baseline_hidden_channels,
    #         'num_layers': args.GCN_baseline_num_layers,
    #         'num_regs': args.GCN_baseline_num_regs,
    #         'num_classes': args.GCN_baseline_num_classes,
    #     },
    #     dataset=darts_graph_dataset,
    #     lr=args.graph_model_lr,
    #     batch_size=args.graph_model_bs,
